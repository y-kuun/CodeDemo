...
static inline void String_setup_skip_chars(
    size_t *skip_chars, const unsigned char *needle, ssize_t nlen)
{
    size_t i = 0;
    size_t last = nlen - 1;
    ...
    size_t *skip_chars)
{
    ...
    assert(haystack != NULL && "Given bad haystack to seach.");
...
int StringScanner_scan(StringScanner *scan, bstring tofind)
{
    ...
    if(found)
    {
        ...
        // move to next pos for next round
